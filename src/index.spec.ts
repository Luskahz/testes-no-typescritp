...
describe("classe ListaNumerica", () => {
  test("validar quantidade de elementos", () => {
    expect(
      new ListaNumerica([10000, 20000, 30000]).possuiQuantidadeValida(),
    ).toBe(false);
    expect(
      new ListaNumerica([1000, 2000, 30000, 40000]).possuiQuantidadeValida(),
    ).toBe(true);
    expect(
      new ListaNumerica([
    ...
    expect(
      new ListaNumerica([
        10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 99999,
      ]).possuiQuantidadeValida(),
    ).toBe(true);
    expect(
      new ListaNumerica([
  ...
  test("validar valores dos elementos", () => {
    expect(
      new ListaNumerica([10000, 20000, 30000, 9999]).possuiValoresValidos(),
    ).toBe(false);
    expect(
      new ListaNumerica([10000, 20000, 30000, 40000]).possuiValoresValidos(),
    ).toBe(true);
    expect(
      new ListaNumerica([10000, 20000, 30000, 50000]).possuiValoresValidos(),
    ).toBe(true);
    expect(
      new ListaNumerica([10000, 20000, 30000, 99999]).possuiValoresValidos(),
    ).toBe(true);
    expect(
      new ListaNumerica([52208, 27270, 65319, 100000]).possuiValoresValidos(),
    ).toBe(false);
  });

  test("validar lista completa", () => {
    expect(new ListaNumerica([52208, 27270, 65319, 10294]).isValid()).toBe(
      true,
    );
    expect(new ListaNumerica([52208, 27270, 65319]).isValid()).toBe(false);
    expect(
      new ListaNumerica([
        52208, 27270, 65319, 10294, 14531, 15968, 70787, 32033, 42199, 57235,
        98958,
      ]).isValid(),
    ).toBe(false);
    expect(
      new ListaNumerica([52208, 27270, 65319, 9999, 98958]).isValid(),
    ).toBe(false);
    expect(
      new ListaNumerica([52208, 27270, 65319, 100000, 98958]).isValid(),
    ).toBe(false);
    expect(
      new ListaNumerica([52208, 27270, 65319, 99999, 98958]).isValid(),
    ).toBe(true);
  });
});
